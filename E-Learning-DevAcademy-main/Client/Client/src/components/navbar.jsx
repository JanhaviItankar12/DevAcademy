                        ...
                        {user ? (
                            <>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent className="w-56 dark:bg-[#0A0A0A]" align="end">
                            ...
                            <div className="flex space-x-3">
                                <Button
                                    ...
                                    className="px-5 cursor-pointer py-2 border-purple-600 text-purple-600 hover:bg-purple-50 dark:text-purple-400 dark:border-purple-400 dark:hover:bg-purple-900/20"
                                >
                                    Sign In
                                </Button>
                                <Button
                                    onClick={() => navigate("/login", { state: { tab: "signup" } })}
                                    className="px-6 cursor-pointer py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-full transition-all"
                                >
                                    Get Started
                                </Button>
                            </div>
